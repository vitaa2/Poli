...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {  
    ...
    // Query untuk mencari pasien berdasarkan nama dan password  
    $query = "SELECT * FROM pasien WHERE nama = '$nama' AND password = '$password'";  
    ...
    if ($result->num_rows == 1) {  
        ...
        $error = "Nama atau password tidak ditemukan";  
    }  
}  
?>  
