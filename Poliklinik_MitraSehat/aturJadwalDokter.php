<?php   
    if (isset($_POST['simpanData'])) {  
        ...
        if (isset($_POST['id'])) {  
            ...
            // Jika status 'Aktif', nonaktifkan semua jadwal lain terlebih dahulu  
            if ($statues == 1) {  
                // Cek apakah ada jadwal lain yang aktif  
                ...
                // Jika ada jadwal aktif lainnya, tidak boleh merubah status yang lain ke aktif  
                if ($activeCount > 0) {  
                    echo "  
                        <script>   
                            alert('Gagal! Tidak bisa mengubah status karena ada jadwal aktif lainnya.');  
                        </script>  
                    ";  
