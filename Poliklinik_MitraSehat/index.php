...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg py-3 navbar-dark">
    <div class="container d-flex align-items-center">
      <a class="navbar-brand" href="#">Poliklinik Mitra Sehat</a>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        <ul class="navbar-nav d-flex align-items-lg-center ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=cekRM">Login Pasien</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=riwayatpasienbynorm">Riwayat Pasien</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=konsultasi">Konsultasi Pasien</a>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
  ...
  <main role="main" class="container">
    ...
    if (isset($_GET['page'])) {
      ...
      echo '<div class="jumbotron">
              ...
              <h2 class="lead">Karena Kesehatan Anda adalah Prioritas Kami.';
      if (isset($_SESSION['username'])) {
        //jika sudah login tampilkan username
        echo '. ' . $_SESSION['username'] . '</h2><hr></div>';
      } else {
